...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/fGNbiZHggg)
...
```sh
npx nx serve official
```

To create a production bundle:

```sh
npx nx build official
```

To see all available targets to run for a project, run:

```sh
npx nx show project official
```
